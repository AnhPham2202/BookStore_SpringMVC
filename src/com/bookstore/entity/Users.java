...
@NamedQueries({
	@NamedQuery(name ="findAllUsers", query = "SELECT u FROM Users u ORDER BY u.fullName"),
	...
	@NamedQuery(name = "findByEmailAndPass", query = "SELECT u FROM Users u WHERE u.email = :email AND u.password = :password")
})
